...
import type { ConfigValueType } from '@/features/app-config'
import { useAppConfig } from '@/composables/useAppConfig'
import ConfigEditModal from './ConfigEditModal.vue'

const {
  CATEGORY_LABELS, loading, clearingCache, selectedTab, searchQuery,
  showEditModal, editingConfig, toast, deleteConfirm,
  typeTabs, filteredConfigs, lastUpdateTime,
  clearCache, handleNewConfig, handleEdit, handleDeleteRequest,
