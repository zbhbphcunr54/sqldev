...
export const lightTheme = EditorView.theme(
  {
    ...
    '.cm-content': {
      ...
      caretColor: 'var(--color-primary, #3b82f6)', padding: '12px 0'
    },
    ...
    '.cm-gutters': {
      ...
      border: 'none', borderRight: '1px solid var(--color-border, #e2e8f0)'
    },
    '.cm-activeLineGutter': {
    ...
    '.cm-tooltip-autocomplete': {
      ...
      '& > ul > li[aria-selected]': {
        backgroundColor: 'var(--color-primary, #3b82f6)', color: 'white'
      }
    },
    '.cm-matchingBracket': {
...
export const darkTheme = EditorView.theme(
  {
    ...
    '.cm-content': {
      fontFamily: "'JetBrains Mono', 'Fira Code', Consolas, monospace",
      caretColor: 'var(--color-primary, #89b4fa)', padding: '12px 0'
    },
    ...
    '.cm-gutters': {
      ...
      border: 'none', borderRight: '1px solid var(--color-border, #313244)'
    },
    '.cm-activeLineGutter': {
    ...
    '.cm-tooltip-autocomplete': {
      ...
      '& > ul > li': { padding: '4px 8px' },
      '& > ul > li[aria-selected]': {
        backgroundColor: 'var(--color-primary, #89b4fa)', color: '#1e1e2e'
      }
    },
    '.cm-matchingBracket': {
